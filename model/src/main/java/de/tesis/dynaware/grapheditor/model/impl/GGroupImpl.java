...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>GGroup</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 *   <li>{@link GGroupImpl#getCoreUid <em>Core Uid</em>}</li>
...
public class GGroupImpl extends GResizableImpl implements GGroup {
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GGROUP__NAME, oldName, name));
	}
