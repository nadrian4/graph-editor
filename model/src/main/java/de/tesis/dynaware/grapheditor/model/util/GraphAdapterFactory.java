...
public class GraphAdapterFactory extends AdapterFactoryImpl {
	...
	protected GraphSwitch<Adapter> modelSwitch =
		new GraphSwitch<Adapter>() {
			...
			@Override
			public Adapter caseGConnectable(GConnectable object) {
				return createGConnectableAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseGCategory(GCategory object) {
				return createGCategoryAdapter();
			}
			@Override
			public Adapter caseGGroup(GGroup object) {
				return createGGroupAdapter();
			}
			@Override
			public Adapter caseGText(GText object) {
				return createGTextAdapter();
			}
			@Override
