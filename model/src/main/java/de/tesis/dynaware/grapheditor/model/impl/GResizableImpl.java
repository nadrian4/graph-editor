 ...
 * @generated
 */
public abstract class GResizableImpl extends MinimalEObjectImpl.Container implements GResizable {
	/**
	...
	public void setX(double newX) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GRESIZABLE__X, oldX, x));
	}
	...
	public void setY(double newY) {
		...
		y = newY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GRESIZABLE__Y, oldY, y));
	}
	...
	public void setWidth(double newWidth) {
		...
		width = newWidth;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GRESIZABLE__WIDTH, oldWidth, width));
	}
	...
	public void setHeight(double newHeight) {
		...
		height = newHeight;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, GraphPackage.GRESIZABLE__HEIGHT, oldHeight, height));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case GraphPackage.GRESIZABLE__X:
				return getX();
			case GraphPackage.GRESIZABLE__Y:
				return getY();
			case GraphPackage.GRESIZABLE__WIDTH:
				return getWidth();
			case GraphPackage.GRESIZABLE__HEIGHT:
				return getHeight();
		}
